...
-- Updates: 
-- 1. One Time ($199) -> 'one_time'
-- 2. Monthly Standard ($199/mo) -> 'monthly_standard'
-- 3. Monthly Premium ($600/mo) -> 'monthly_premium'

-- Re-create type to ensure it matches new requirements and exists
