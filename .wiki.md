```markdown
# Project Summary
The "Talk to My Lawyer" project is a SaaS application designed to streamline the generation and review of legal documents. It supports three user roles: Subscribers who create legal letters, Employees who assist in sales and earn commissions through coupon codes, and Admins who review and approve the generated letters. The platform utilizes AI for drafting legal documents and integrates with payment processors for managing subscriptions.
...
- `migrations/COMPLETE_MIGRATION.sql`: SQL script that sets up all necessary database tables.
