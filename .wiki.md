# Project Summary
The "Talk to My Lawyer" project is a SaaS application designed to streamline the creation and review of legal documents. It serves three user roles: Subscribers who generate legal letters, Employees who facilitate sales through coupon codes, and Admins who oversee document approval. The platform utilizes AI technology to draft documents and integrates with payment processors to manage subscriptions, enhancing accessibility and efficiency in legal services.
...
- `migrations/fixed_005_no_enum.sql`: Corrected SQL migration for letter allowance system without enum dependency.
